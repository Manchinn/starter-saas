        ...
        <table class="w-full text-sm">
          <thead>
            <tr class="bg-gray-50 border-b border-gray-100 text-left">
              ...
              <th class="px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide">Last Login</th>
            ...
            <tr v-for="u in users" :key="u.id" class="hover:bg-gray-50 transition-colors group">
              ...
              <td class="px-5 py-3.5">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <p class="font-medium text-gray-900 leading-tight">{{ u.name }}</p>
              ...
              <!-- System role -->
              <td class="px-5 py-3.5">
                <span :class="systemRoleBadge(u.role)"
              ...
              <!-- Status -->
              <td class="px-5 py-3.5">
                <span :class="u.isActive ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'"
                  class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold">
                  <span class="w-1.5 h-1.5 rounded-full" :class="u.isActive ? 'bg-green-500' : 'bg-red-500'"></span>
                  {{ u.isActive ? 'Active' : 'Inactive' }}
                </span>
              </td>

              <!-- Joined -->
              <td class="px-5 py-3.5 text-gray-500 text-xs">{{ fmtDate(u.createdAt) }}</td>

              <!-- Last login -->
              <td class="px-5 py-3.5 text-gray-500 text-xs">{{ u.lastLoginAt ? fmtDate(u.lastLoginAt) : '—' }}</td>
