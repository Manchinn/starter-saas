<template>
  <div v-if="show"
    class="unverified-email-banner mb-4 flex flex-wrap items-center gap-3 px-4 py-3 bg-amber-50 border border-amber-200 text-amber-900 rounded-xl text-sm">
...
<style>
@media print {
  .unverified-email-banner { display: none !important; }
}
</style>
