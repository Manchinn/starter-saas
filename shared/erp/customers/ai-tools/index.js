...
//
// Tools are auto-discovered by shared/ai-agent/services/tools.js. Each runs
// server-side with ctx = { user: { id, organizationId } } and returns
// { result, action? } — `result` is summarized back to the model, `action`
// (e.g. a navigate) is forwarded to the browser.
//
...
// the name is blank or no active group matches.
