    ...
    <div class="space-y-6">
      ...
      <div v-else class="bg-white rounded-2xl border border-[#E2E8F0] p-6 space-y-5">
        ...
        <div class="flex justify-between items-center pt-2">
          <button @click="confirmDelete" class="px-4 py-2 text-sm text-red-500 border border-red-200 hover:bg-red-50 transition">{{ t('erp.stores.deleteStore') }}</button>
          <div class="flex gap-3">
            <RouterLink to="/erp/stores" class="px-4 py-2 text-sm border hover:bg-[#F7F9FC] transition">{{ t('common.cancel') }}</RouterLink>
