  ...
  <AppLayout>
    <div class="max-w-2xl space-y-6">
      ...
      <div v-else-if="notFound" class="bg-red-50 text-red-700 text-sm px-4 py-3 rounded-lg">
        Store not found. <RouterLink to="/erp/stores" class="underline ml-1">Back to list</RouterLink>
      </div>
      ...
      <div v-else class="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
        ...
        <div class="flex justify-between items-center pt-2">
          <button @click="confirmDelete" class="px-4 py-2 text-sm text-red-500 border border-red-200 rounded-lg hover:bg-red-50 transition">Delete Store</button>
