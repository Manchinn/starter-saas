      ...
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2.5">
            <h1 class="text-xl font-bold text-[#1C2434]">{{ t('erp.billingNotes.new') }}</h1>
          ...
          <nav class="flex items-center gap-1.5 mt-1">
            <RouterLink to="/erp/billing/billing-notes" class="text-[12px] text-[#9BA7B0] hover:text-[#637381] transition-colors">{{ t('erp.billingNotes.title') }}</RouterLink>
      ...
      <div class="space-y-5">
        ...
        <div class="bg-white rounded-2xl border border-[#E2E8F0] shadow-card overflow-hidden">
          <div class="px-6 py-4 border-b border-[#E2E8F0] flex items-center gap-3">
            ...
            <h2 class="text-sm font-semibold text-[#1C2434]">{{ t('erp.billingNotes.info') }}</h2>
          </div>
          <div class="px-6 py-5">
            <div class="grid grid-cols-2 gap-x-6 gap-y-5">
              ...
              <!-- Due Date -->
              <div>
                <label class="block text-[11px] font-semibold text-[#637381] uppercase tracking-wider mb-1.5">{{ t('erp.billingNotes.colDueDate') }}</label>
        ...
        <div class="bg-white rounded-2xl border border-[#E2E8F0] shadow-card overflow-hidden">
          ...
          <div class="px-6 py-5 bg-[#F7F9FC] border-t border-[#E2E8F0] flex items-center justify-between">
            <div>
              <p class="text-[11px] font-semibold text-[#9BA7B0] uppercase tracking-wider mb-0.5">{{ t('erp.billingNotes.grandTotal') }}</p>
...
import {
  ...
  DocumentTextIcon, ArrowPathIcon, ClipboardDocumentListIcon, CalculatorIcon, UserIcon,
...
async function save() {
  ...
  try {
    ...
    globalError.value = d?.errors?.map(e => e.message).join(', ') || d?.message || t('erp.billingNotes.errCreate')
  } finally {
    saving.value = false
  }
}
