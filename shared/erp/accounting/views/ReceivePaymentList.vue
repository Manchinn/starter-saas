      ...
      <div class="bg-white rounded-2xl border border-[#E2E8F0] shadow-sm overflow-hidden">
        ...
        <div class="px-5 py-3 border-b border-[#E2E8F0] flex items-center gap-3">
          <div class="relative flex-1 min-w-0">
            ...
            <input v-model="search" @input="onSearch" type="search" :placeholder="t('erp.receivePayments.searchPh')"
...
import { PlusIcon, MagnifyingGlassIcon, EyeIcon, BanknotesIcon } from '@heroicons/vue/24/outline'
...
function onSearch() {
  ...
  searchTimeout = setTimeout(() => { page.value = 1; fetchPayments() }, 350)
}
