...
const controller = require('../controllers/debit-note.controller')
const { createRules } = require('../validators/debit-note.validators')
...
module.exports = { mountPath: '/billing/debit-notes', router }
