export default {
  erp: {
    quotations: {
      ...
      docAddress:              'Address',
      docQuotationNo:          'Quotation No.',
      docVat:                  'VAT',
      docNetTotal:             'Net Total',
      docTerm1:                'This quotation is valid until the date specified above.',
      docTerm2:                'Prices quoted are subject to change without prior notice.',
