          ...
          <tbody class="divide-y divide-gray-100">
            ...
            <tr v-for="p in items" :key="p.id" class="hover:bg-gray-50 transition">
              ...
              <td class="px-5 py-3 text-right whitespace-nowrap">
                <RouterLink v-can="'erp.products.edit'" :to="`/erp/item-master/${p.id}/edit`" class="text-primary-600 hover:underline text-xs mr-3">Edit</RouterLink>
                <button v-can="'erp.products.delete'" @click="confirmDelete(p)" class="text-red-500 hover:underline text-xs">Delete</button>
              </td>
            </tr>
          </tbody>
        </table>
