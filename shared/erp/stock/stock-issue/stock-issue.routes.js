...
const controller = require('./stock-issue.controller')
...
// Returns products that have stock > 0 in the given store (issue depletes stock,
// so a row with zero balance is meaningless to surface).
...
module.exports = { mountPath: '/stock-issue', router }