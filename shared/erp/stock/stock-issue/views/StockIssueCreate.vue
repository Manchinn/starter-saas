  ...
  <AppLayout>
    <div class="space-y-6">
      <div class="flex items-center gap-3">
        ...
        <h1 class="text-2xl font-bold text-gray-900">New Stock Issue</h1>
      </div>
      ...
      <div class="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-4 gap-4">
          ...
          <div>
            ...
            <input v-model="form.reason" type="text" placeholder="e.g. Production use, Internal consumption"
              class="w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500" />
          </div>
          <div>
      ...
      <div class="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div v-if="!form.storeId" class="py-10 text-center text-sm text-gray-400">
          Select a <span class="font-medium text-gray-600">Store</span> above to load available products.
        </div>
        ...
        <table v-else class="w-full text-sm">
          <thead class="bg-gray-50 border-b border-gray-200 text-left">
            <tr>
              ...
              <th class="px-3 py-2 font-medium text-gray-600 w-36">Issue Qty <span class="text-red-500">*</span></th>
      ...
      <div class="flex justify-end gap-3">
        <RouterLink to="/erp/stock-issue" class="px-4 py-2 text-sm border rounded-lg hover:bg-gray-50 transition">Cancel</RouterLink>
