          ...
          <div class="p-6">
            ...
            <header class="flex items-start justify-between gap-6">
              ...
              <div class="text-right flex-shrink-0">
                <h2 class="text-[18px] font-bold text-[#1C2434] leading-tight">{{ t('erp.stockIssue.documentTitle') }}</h2>
              </div>
            </header>
...
const fillerRows = computed(() => Math.max(0, 8 - (issue.value?.items?.length || 0)))
