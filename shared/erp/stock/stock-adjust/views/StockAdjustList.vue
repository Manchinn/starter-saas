  ...
  <AppLayout>
    <div class="space-y-5">
      ...
      <div class="flex items-center justify-between gap-4">
        <div>
          <h1 class="text-xl font-semibold text-gray-900">Stock Adjustments</h1>
            ...
            <tr v-for="row in rows" :key="row.id" class="hover:bg-gray-50 transition-colors">
              ...
              <td class="px-5 py-3.5">
                <div class="flex items-center justify-end gap-1.5">
                  <RouterLink :to="`/erp/stock-adjust/${row.id}`"
...
import { PlusIcon, MagnifyingGlassIcon, EyeIcon, CheckCircleIcon, TrashIcon, ChevronLeftIcon, ChevronRightIcon, AdjustmentsHorizontalIcon } from '@heroicons/vue/24/outline'
