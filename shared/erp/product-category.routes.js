...
const controller = require('./product-category.controller')
...
router.post('/',      requirePermission('erp.products.edit'),   validation, (req, res) => controller.create(req, res))
router.put('/:id',    requirePermission('erp.products.edit'),   validation, (req, res) => controller.update(req, res))
