...
export default {
  ...
  routes: [
    ...
    // Customers
    {
      path: '/erp/customers',
      name: 'erp-customers',
      component: () => import('./customers/views/customers/CustomersList.vue'),
      meta: { requiresAuth: true, title: 'Customers' },
    },
    {
      path: '/erp/customers/create',
      name: 'erp-customers-create',
      component: () => import('./customers/views/customers/CustomerCreate.vue'),
      meta: { requiresAuth: true, title: 'New Customer' },
    },
    {
      path: '/erp/customers/:id/edit',
      name: 'erp-customers-edit',
      component: () => import('./customers/views/customers/CustomerEdit.vue'),
    ...
    // Stores
    {
      path: '/erp/stores',
      name: 'erp-stores',
      component: () => import('./inventory/views/stores/StoresList.vue'),
      meta: { requiresAuth: true, title: 'Stores' },
    },
    {
      path: '/erp/stores/create',
      name: 'erp-stores-create',
      component: () => import('./inventory/views/stores/StoreCreate.vue'),
      meta: { requiresAuth: true, title: 'New Store' },
    },
    {
      path: '/erp/stores/:id/edit',
      name: 'erp-stores-edit',
      component: () => import('./inventory/views/stores/StoreEdit.vue'),
    ...
    // UOM
    {
      path: '/erp/uom',
      name: 'erp-uom',
      component: () => import('./inventory/views/uom/UOMList.vue'),
      meta: { requiresAuth: true, title: 'Units of Measure' },
    },
    {
      path: '/erp/uom/create',
      name: 'erp-uom-create',
      component: () => import('./inventory/views/uom/UOMCreate.vue'),
      meta: { requiresAuth: true, title: 'New UOM' },
    },
    {
      path: '/erp/uom/:id/edit',
      name: 'erp-uom-edit',
      component: () => import('./inventory/views/uom/UOMEdit.vue'),
    ...
    // UOM Conversion
    {
      ...
      component: () => import('./inventory/views/uom-conversion/UOMConversionList.vue'),
      meta: { requiresAuth: true, title: 'UOM Conversion' },
    },
    {
      path: '/erp/uom-conversion/create',
      name: 'erp-uom-conversion-create',
      component: () => import('./inventory/views/uom-conversion/UOMConversionCreate.vue'),
      meta: { requiresAuth: true, title: 'New UOM Conversion' },
    },
    {
      path: '/erp/uom-conversion/:id/edit',
      name: 'erp-uom-conversion-edit',
      component: () => import('./inventory/views/uom-conversion/UOMConversionEdit.vue'),
    ...
    // Settings: General
    {
      ...
      component: () => import('./settings/views/general/GeneralSettings.vue'),
    ...
    // Settings: Approval Thresholds
    {
      ...
      component: () => import('./settings/views/thresholds/ApprovalThresholdsManage.vue'),
    ...
    // Settings: Currencies + Exchange Rates
    {
      ...
      component: () => import('./settings/views/currencies/CurrenciesManage.vue'),
    ...
    // Accounting: Tax Periods
    {
      ...
      component: () => import('./accounting/views/tax-periods/TaxPeriodsManage.vue'),
      meta: { requiresAuth: true, title: 'Tax Periods' },
    },
    {
      path: '/erp/accounting/tax-periods/:id/vat-report',
      name: 'erp-accounting-vat-report',
      component: () => import('./accounting/views/vat-report/VatReport.vue'),
    ...
    // Settings: Sequence Numbers
    {
      ...
      component: () => import('./settings/views/sequences/SequenceList.vue'),
      meta: { requiresAuth: true, title: 'Sequence Numbers' },
    },
    {
      path: '/erp/settings/sequence/create',
      name: 'erp-settings-sequence-create',
      component: () => import('./settings/views/sequences/SequenceEdit.vue'),
    ...
    // Chart of Accounts
    {
      ...
      component: () => import('./accounting/views/chart-of-accounts/ChartOfAccountsList.vue'),
    ...
    },
    {
      ...
      component: () => import('./accounting/views/chart-of-accounts/ChartOfAccountCreate.vue'),
    ...
    },
    {
      ...
      component: () => import('./accounting/views/chart-of-accounts/ChartOfAccountEdit.vue'),
    ...
    // Receive Payments
    {
      ...
      component: () => import('./accounting/views/receive-payment/ReceivePaymentList.vue'),
    ...
    },
    {
      ...
      component: () => import('./accounting/views/receive-payment/ReceivePaymentCreate.vue'),
    ...
    },
    {
      ...
      component: () => import('./accounting/views/receive-payment/ReceivePaymentDetail.vue'),
    ...
    // Vendor Bills (AP)
    {
      ...
      component: () => import('./accounting/views/vendor-bill/VendorBillsList.vue'),
      meta: { requiresAuth: true, title: 'Vendor Bills' },
    },
    {
      path: '/erp/purchasing/bills/:id',
      name: 'erp-purchasing-bills-detail',
      component: () => import('./accounting/views/vendor-bill/VendorBillDetail.vue'),
    ...
    // Purchase Requisitions
    {
      ...
      component: () => import('./purchasing/views/purchase-requisition/PurchaseRequisitionList.vue'),
    ...
    },
    {
      ...
      component: () => import('./purchasing/views/purchase-requisition/PurchaseRequisitionCreate.vue'),
    ...
    },
    {
      ...
      component: () => import('./purchasing/views/purchase-requisition/PurchaseRequisitionDetail.vue'),
    ...
    // AR Aging Report
    {
      ...
      component: () => import('./accounting/views/ar-aging/ARAgingReport.vue'),
    ...
    // Settings — Demo Data
    {
      ...
      component: () => import('./settings/views/demo/DemoData.vue'),
