              ...
              <div class="col-span-2 lg:col-span-1">
                ...
                <select v-model="form.vendorId"
                  :class="['w-full px-3.5 py-2.5 border text-sm bg-white transition-colors',
                           ...
                           errors.vendorId ? 'border-red-300 bg-red-50' : 'border-[#E2E8F0] text-[#1C2434]']">
                  <option value="">— {{ t('erp.po.selectVendor') }} —</option>
              ...
              <div>
                ...
                <select v-model="form.requisitionId"
                  class="w-full px-3.5 py-2.5 border border-[#E2E8F0] text-sm bg-white text-[#1C2434]
                         focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-400 transition-colors">
                  <option value="">— {{ t('erp.po.noRequisition') }} —</option>
                  <option v-for="r in requisitions" :key="r.id" :value="r.id">{{ r.refNo }}</option>
                </select>
              </div>
