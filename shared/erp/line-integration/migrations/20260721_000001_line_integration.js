module.exports = {
  async up(ctx) {
    const { queryInterface, DataTypes, tableExists, addIndex } = ctx
    ...
    // Idempotent helper — sequelize.sync() may already have created this index.
    await addIndex('line_user_mappings', ['organizationId', 'lineUserId'], {
      unique: true,
      name: 'line_user_mappings_org_user_unique',
    })
  },
