...
class OrderController extends BaseController {
  ...
  async create(req, res) {
    try {
      ...
      return this.created(res, { order }, 'Order created')
    } catch (err) {
      return this.fail(res, err.message, err.status || 400)
    }
  }
  ...
  async update(req, res) {
    try {
      ...
      return this.ok(res, { order }, 'Order updated')
    } catch (err) {
      return this.fail(res, err.message, err.status || 400)
    }
  }
  ...
  async updateStatus(req, res) {
    try {
      ...
      return this.ok(res, { order }, 'Order status updated')
    } catch (err) {
      return this.fail(res, err.message, err.status || 400)
    }
  }
  ...
  async remove(req, res) {
    try {
      ...
      return this.ok(res, null, 'Order deleted')
    } catch (err) {
      return this.fail(res, err.message, err.status || 400)
    }
  }
  ...
  async updateItem(req, res) {
    try {
      ...
      return this.ok(res, { item }, 'Order item updated')
    } catch (err) {
      return this.fail(res, err.message, err.status || 400)
    }
  }
  ...
  async deleteItem(req, res) {
    try {
      ...
      return this.ok(res, null, 'Order item deleted')
    } catch (err) {
      return this.fail(res, err.message, err.status || 400)
    }
  }
