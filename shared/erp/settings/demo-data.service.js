...
async function seedDemo(userId, orgId) {
  ...
  try {
    ...
    const [retail, wholesale] = await Promise.all([
      CustomerGroup.create({ name: 'Retail',    description: 'Walk-in customers',     organizationId: orgId }, { transaction: t }),
    ...
    await Promise.all([
      ...
      Vendor.create({ code: 'VND-0004', name: 'CleanPro Services',  contactPerson: 'Linda Ho',   email: 'linda@cleanpro.com',     phone: '555-0204', vendorTypes: ['service_provider'],             createdBy: userId, organizationId: orgId }, { transaction: t }),
      Vendor.create({ code: 'VND-0005', name: 'SwiftLogistics Co.', contactPerson: 'Mark Tan',   email: 'mark@swiftlogistics.com',phone: '555-0205', vendorTypes: ['service_provider'],             createdBy: userId, organizationId: orgId }, { transaction: t }),
      Vendor.create({ code: 'VND-0006', name: 'UniTrade Partners',  contactPerson: 'Nora Lim',   email: 'nora@unitrade.com',      phone: '555-0206', vendorTypes: ['supplier', 'service_provider'], createdBy: userId, organizationId: orgId }, { transaction: t }),
    ])
